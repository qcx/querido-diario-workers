...
const types = ['instar', 'dosp', 'adiarios_v1', 'adiarios_v2', 'diof', 'doem', 'barco_digital', 'siganet', 'diario_oficial_br', 'modernizacao', 'aplus', 'dioenet', 'administracao_publica', 'ptio', 'municipio_online', 'atende_v2'];
