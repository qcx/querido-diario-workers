...
export interface PrefeituracajazeirasConfig {
  ...
  /** Base URL of the gazette page (e.g., "https://www.cajazeiras.pb.gov.br/diariooficial.php") */
  baseUrl: string;
 ...
 *
 * Example: https://www.cajazeiras.pb.gov.br/diariooficial.php
 */
export class PrefeituracajazeirasSpider extends BaseSpider {
  protected platformConfig: PrefeituracajazeirasConfig;

  constructor(spiderConfig: SpiderConfig, dateRange: DateRange) {
    super(spiderConfig, dateRange);
    this.platformConfig = spiderConfig.config as PrefeituracajazeirasConfig;

    if (!this.platformConfig.baseUrl) {
      throw new Error(
        `PrefeituracajazeirasSpider requires a baseUrl in config for ${spiderConfig.name}`,
      );
    }

    logger.info(
      `Initializing PrefeituracajazeirasSpider for ${spiderConfig.name} with URL: ${this.platformConfig.baseUrl}`,
    );
  }
